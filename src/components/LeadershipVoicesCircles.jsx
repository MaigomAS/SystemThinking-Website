  ...
  en: [
    {
      ...
      role: "Head of the Women's Secretariat",
      sector: 'Apodaca, Mexico',
      initials: 'EE',
      details: [
        "Head of the Women's Secretariat, Apodaca, Mexico",
        'Local government',
        'Care ecosystem',
        'Public policy',
      ],
    ...
    },
    {
      ...
      linkedInUrl: 'https://www.linkedin.com/in/agustinlanda/',
      summary:
        'A leading voice in systems thinking and strategy, with direct application in social change processes in the third sector.',
      role: 'Founder of LANZA',
      sector: 'Civil society leader',
      initials: 'AL',
      details: [
        'Civil society leader',
        'Founder of LANZA',
        'Pioneer in systems thinking and strategy applied to social change in the third sector.',
        'Consultant in fundraising, community foundations, ESG principles, and the creation and development of CSO boards.',
        'Pioneer in systems thinking and strategy applied to social change in the third sector.',
      ],
      insightTitle: 'Anticipating change by connecting systemic dots',
      testimonial:
        '“Leaders in any sector have the capacity to prevent or anticipate what is going to happen. To do that, it is important to connect the different points and understand that solutions are not single-factor; this is decisive for successfully fulfilling purpose. People have always talked about this around the world, but in reality we do little to live it because it requires a long-term vision that goes far beyond one’s personal life.”',
      imageSrc: sofiaPortrait,
    },
    {
      id: 'voice-3',
      ...
      details: [
        ...
        'Ecosystem leadership, strategy, and network weaving to transform the third sector.',
      ],
      insightTitle: 'Leading systemic transitions through multi-stakeholder alliances',
      testimonial:
        '“Since I encountered these perspectives, my paradigm changed—and with it, my life purpose. We have already crossed 7 of the 9 planetary boundaries and continue operating from the same paradigms… despite billions of dollars invested and global agreements, little or nothing has changed. We must transform the way we observe and act within the system…\n\nA program that integrates these dimensions not only improves technical decisions; it also transforms the quality of consciousness from which those decisions are made.”',
      imageSrc: andresPortrait,
    },
  ],
};
