...
function HeroRotator() {
  ...
  const renderHeroContent = (className = '') => (
    <div className={`playground-hero__content ${className}`.trim()}>
              ...
              <div className="playground-hero__split">
                <div className="hero-loop" aria-hidden="true">
                  ...
                  <div className="hero-loop__signals">
                    <span className="hero-loop__signal hero-loop__signal--primary">{t.heroRotator.signals.primary}</span>
                    <span className="hero-loop__signal hero-loop__signal--secondary">{t.heroRotator.signals.secondary}</span>
                  </div>
                </div>
                {renderHeroContent()}
              </div>
            ) : (
              renderHeroContent('playground-hero__content--editorial')
            );
