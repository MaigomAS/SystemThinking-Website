...
import { E_CALL_BACK_URL, E_CALL_ROOM_URL, E_CALL_WHATSAPP_PHONE } from './config.js';
import useECallLanguage from './i18n/useECallLanguage.js';

function ECallPage() {
  const { t, language, setLanguage } = useECallLanguage();
  ...
  const whatsappLink = useMemo(
    () => `https://wa.me/${E_CALL_WHATSAPP_PHONE}?text=${encodeURIComponent(t.ecall.whatsappMessage)}`,
        ...
        <Container>
          <nav className="navbar__inner" aria-label={t.ecall.aria.nav}>
            ...
            <div className="ecall-nav__links">
              <a href={E_CALL_BACK_URL} className="ecall-nav__link">
            ...
            <div className="ecall-hero__grid">
              <div className="ecall-hero__content">
                ...
                <div className="ecall-hero__actions">
                  ...
                  <Button as="a" href={E_CALL_BACK_URL} variant="secondary" aria-label={t.ecall.aria.back}>
                    {t.ecall.actions.back}
                  </Button>
                </div>
